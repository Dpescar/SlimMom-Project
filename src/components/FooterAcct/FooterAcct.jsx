            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleClose}>
                  ...
                  >
                    <MenuItem data-my-value="archive" onClick={handleClose}>
                      Archive Dairy Data
                    </MenuItem>
                    <MenuItem data-my-value="review" onClick={handleReview}>
                      Review Previous Archives Data
                    </MenuItem>
                    <MenuItem data-my-value="dairy" onClick={handleClose}>
                      Delete Dairy and Caculator Data
                    </MenuItem>
                    <MenuItem data-my-value="acct" onClick={handleClose}>
                      Delete Accout
                    </MenuItem>
                  </MenuList>
                </ClickAwayListener>
